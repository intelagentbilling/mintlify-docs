---
title: "Bill a single visit"
description: "Raise one claim from scratch, and let the health card fill in the rest"
---
...
you change the date. See [Find a claim and fix what went wrong](/docs/guides/find-and-fix-claims).
